  ...
  var TT_TWISTERS = [
    ...
    },
    {
      ...
      th: '\u0E2A\u0E32\u0E27\u0E41\u0E2A\u0E19\u0E2A\u0E27\u0E22 ' +
          '\u0E43\u0E2A\u0E48\u0E40\u0E2A\u0E37\u0E49\u0E2D\u0E2A\u0E35\u0E41\u0E14\u0E07 ' +
          '\u0E2A\u0E27\u0E21\u0E2A\u0E31\u0E49\u0E19\u0E2A\u0E39\u0E07\u0E2A\u0E35\u0E2A\u0E49\u0E21',
      en: 'A very pretty girl wearing a red shirt and a tall orange mini-skirt',
  ...
  var TTD = (function () {
    ...
    function condition(pts) {
      ...
      /* Trim the edges. ASYMMETRIC, and it must stay that way — this was a
         ...
         edges cannot interact. */
      var kA = Math.floor(q.length * COND_TRIM_LEAD);
      var kB = Math.floor(q.length * COND_TRIM_TAIL);
      if (q.length - kA - kB >= 6) q = q.slice(kA, q.length - kB);
    ...
    function analyse(frames, liveThreshold, centreHz, twister) {
      ...
      for (var i = 0; i < N; i++) {
        ...
        var core = cond.map(function (p) {
          var v2 = st(p.hz, centre) - (dec.icept + dec.slope * p.t);
