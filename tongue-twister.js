...
(function () {
  ...
  function buildMarkup() {
    ...
    view.innerHTML =
      ...
      '<div class="tt-practice">' +
        ...
        '<div class="menu-section">' +
          '<div class="tt-graph-cap" id="tt-graph-cap"></div>' +
  ...
  function playAudio(slow, startMs, endMs) {
    ...
    if (refGraph && audioEl.error == null) {
      if (!graphData || graphData.kind !== 'reference') showGraph(refGraph);
    }
    try {
  ...
  function showGraph(out) {
    ...
    setGraphCaption(out ? (out.kind === 'reference'
      ? '\uD83D\uDD08 Native speaker' : 'Your attempt') : '', out && out.kind === 'reference');
    ...
    var lg = $('tt-legend');
    if (lg) lg.hidden = !out || !TT_DEBUG_GRAPH;
    drawGraph();
  }
