...
(function () {
  ...
  // "Unsure"), then pick the one whose contour sits closest to that tone's
  // TONE_REFS guide shape. Both halves matter: correctness alone can be bought
  // by parking a falling word 8 semitones above centre, which classifies fine and
  // draws as nonsense.
  //
  ...
  const TONE_WORDS = [
    { id: 'gin',   tone: 'mid',      thai: 'กิน',   rom: 'gin',    gloss: 'to eat',                 centreHz: 206.4,
    ...
    { id: 'bpai',  tone: 'mid',      thai: 'ไป',    rom: 'bpai',   gloss: 'to go',                  centreHz: 209.4,
    ...
    { id: 'nom',   tone: 'mid',      thai: 'นม',    rom: 'nom',    gloss: 'milk',                   centreHz: 209.4,
    ...
    { id: 'gai',   tone: 'low',      thai: 'ไก่',   rom: 'gài',    gloss: 'chicken',                centreHz: 212.4,
    ...
    { id: 'yoo',   tone: 'low',      thai: 'อยู่',  rom: 'yòo',    gloss: 'to be at (location)',    centreHz: 221.8,
    ...
    { id: 'pet',   tone: 'low',      thai: 'เผ็ด',  rom: 'pèt',    gloss: 'spicy',                  centreHz: 173.5,
    ...
    { id: 'sip',   tone: 'low',      thai: 'สิบ',   rom: 'sìp',    gloss: 'ten (10)',               centreHz: 260,  
    ...
    { id: 'chuu',  tone: 'falling',  thai: 'ชื่อ',  rom: 'chûu',   gloss: 'name',                   centreHz: 225,  
    ...
    { id: 'chop',  tone: 'falling',  thai: 'ชอบ',   rom: 'chôp',   gloss: 'to like',                centreHz: 218.6,
    ...
    { id: 'baan',  tone: 'falling',  thai: 'บ้าน',  rom: 'bâan',   gloss: 'house; home',            centreHz: 209.4,
    ...
    { id: 'daai',  tone: 'falling',  thai: 'ได้',   rom: 'dâai',   gloss: 'can',                    centreHz: 178.6,
      points: [[0,200],[10,200],[20,200],[30,197.3],[40,195.4],[50,195.4],[60,195.4],[70,195.4],[80,196.8],[90,198.4],[100,200],[110,201.5],[120,202.5],[130,203.6],[140,204.5],[150,205.4],[160,206.4],[170,207.3],[180,208],[190,208.5],[200,209.1],[210,209.3],[220,209.4],[230,209.4],[240,209.1],[250,209.1],[260,208.7],[270,208.1],[280,207.5],[290,206.7],[300,206],[310,204.9],[320,204.3],[330,203.6],[340,202.3],[350,201.3],[360,199.9],[370,198.5],[380,196.5],[390,194.7],[400,192.7],[410,189.9],[420,185.6],[430,181],[440,177.7],[450,174.8],[460,172.8],[470,170.9],[480,170.9],[490,170.7],[500,170.7],[510,170.9]] },
    { id: 'rak',   tone: 'high',     thai: 'รัก',   rom: 'rák',    gloss: 'to love',                centreHz: 218.6,
    ...
    { id: 'rot',   tone: 'high',     thai: 'รถ',    rom: 'rót',    gloss: 'car; vehicle',           centreHz: 209.4,
    ...
    { id: 'maah',  tone: 'high',     thai: 'ม้า',   rom: 'máa',    gloss: 'horse',                  centreHz: 148,  
      points: [[0,154.3],[10,154.3],[20,152.4],[30,151.3],[40,151.3],[50,151.3],[60,153.2],[70,158.3],[80,158.3],[90,158.3],[100,158.3],[110,158.3],[120,158.3],[130,158.6],[140,158.8],[150,158.8],[160,158.8],[170,158.1],[180,157.2],[190,156.1],[200,155.2],[210,153.7],[220,153.1],[230,152.5],[240,151.9],[250,151.2],[260,150.9],[270,150.2],[280,150.2],[290,150.2],[300,150.2],[310,150.2],[320,150.2],[330,150.3],[340,150.4],[350,150.7],[360,150.9],[370,150.9],[380,151],[390,151.2],[400,151.4],[410,151.9],[420,152.1],[430,152.3],[440,152.9],[450,153.7],[460,155.5],[470,156.6],[480,158.1],[490,159.8],[500,161.7],[510,164.2],[520,167],[530,170.3],[540,174.4],[550,182.7],[560,188.2],[570,193.2],[580,200.6],[590,205.7],[600,210.2],[610,214],[620,217.6],[630,221.1],[640,223.6],[650,226.9],[660,226.9],[670,226.9],[680,226.2],[690,222.8],[700,219.4],[710,216.4],[720,212],[730,207.3],[740,201.3],[750,198.3],[760,180.5],[770,180.5],[780,177]] },
    { id: 'moo',   tone: 'rising',   thai: 'หมู',   rom: 'mŏo',    gloss: 'pork',                   centreHz: 218.6,
    ...
    { id: 'chan',  tone: 'rising',   thai: 'ฉัน',   rom: 'chăn',   gloss: 'I; me (female)',         centreHz: 203.4,
    ...
    { id: 'maar',  tone: 'rising',   thai: 'หมา',   rom: 'măa',    gloss: 'dog',                    centreHz: 159.1,
    ...
    { id: 'suay',  tone: 'rising',   thai: 'สวย',   rom: 'sŭay',   gloss: 'beautiful',              centreHz: 178.6,
      points: [[0,162.3],[10,159.4],[20,157.2],[30,155.2],[40,153.3],[50,150.9],[60,147.6],[70,145.1],[80,143.6],[90,142.1],[100,141.6],[110,141.3],[120,141],[130,141],[140,141],[150,141.2],[160,141.2],[170,141.4],[180,141.7],[190,142.4],[200,142.4],[210,142.4],[220,141],[230,140.1],[240,140],[250,138.6],[260,138.5],[270,138],[280,137.6],[290,137.3],[300,137.2],[310,137.2],[320,137.2],[330,137.4],[340,137.5],[350,138.1],[360,138.2],[370,139.6],[380,141.3],[390,141.7],[400,142.1],[410,145.7],[420,145.7],[430,150.8],[440,152.3],[450,155.1],[460,161.7],[470,165.9],[480,174.2],[490,181.7],[500,187.8],[510,193.6],[520,199.3],[530,206],[540,211.3],[550,217.8],[560,225],[570,233],[580,240],[590,246.5],[600,253.6],[610,260.3],[620,264.4],[630,268],[640,271.6],[650,279.2],[660,281.2],[670,284.2],[680,281.2]] },
  ];
  ...
  function playRefWord(id) {
    ...
    try {
      refAudio.src = 'audio/tone-words/' + w.id + '.mp3';
